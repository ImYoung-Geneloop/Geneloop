    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            client.embed({
               ...
               {
                    name: "ℹ️┆Information",
                    value: `Geneloop is a bot with which you can run your entire server! With no less than 350+ commands, we have a large bot with many options to improve your server!`,
                    inline: false,
                },
                {
                    name: "_____ \n\n│General",
                ...
                {
                    name: "🔧┆Bot owner",
                    value: `<@!774354935906959380> `,
                    inline: true,
                },
                {
                    name: "🔧┆Bot developer",
                    value: `<@!774354935906959380> <@!790975999344246805>`,
                    inline: true,
                },
                {
                    name: "💻┆Commands",
